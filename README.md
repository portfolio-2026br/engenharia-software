...
2. [Sobre Este Projeto](#sobre-este-projeto)
   ...
   5. Ensaio sobre [Segurança by Design](Segurança/README.md)
   6. Desenvolvimento de [Dashboard de tráfego nos repositórios GitHub](Dashboard/README.md)
...
Moro no Vale do Paraíba e tenho me especializado em nuvem e automação nos últimos anos. Concluí, no Instituto Federal de
São Paulo (IFSP), a academia AWS:
